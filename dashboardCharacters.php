...
if (isset($_POST['detalles'])) {
    header('Location: charactersDetails.php');
    exit();
}
...
<body>
    <div class="dashboard-container">
        <h1>Bienvenido, Este es tu personaje</h1>
        <h2>Tu personaje</h2>
        ...
        <form method="POST">
            <button type="submit" name="train">Ir al Torneo</button>
            <button type="submit" name="detalles" name="detalles">Detalles</button>
